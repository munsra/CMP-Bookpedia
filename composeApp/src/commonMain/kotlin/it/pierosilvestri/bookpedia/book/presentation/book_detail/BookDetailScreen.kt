...
import it.pierosilvestri.bookpedia.book.presentation.book_detail.component.BlurredImageBackground
import it.pierosilvestri.bookpedia.book.presentation.book_detail.component.BookChip
import it.pierosilvestri.bookpedia.book.presentation.book_detail.component.ChipSize
import it.pierosilvestri.bookpedia.book.presentation.book_detail.component.TitledContent
    ...
    BlurredImageBackground(
        ...
        if (state.book != null) {
            Column(
                ...
                Text(
                    text = if (state.book.description.isNullOrBlank()) stringResource(Res.string.description_unavailable) else
                        state.book.description,
                    style = MaterialTheme.typography.bodyMedium,
                    textAlign = TextAlign.Justify,
                    color = if (state.book.description.isNullOrBlank()) Color.Black.copy(alpha = 0.4f) else
                        Color.Black,
                    modifier = Modifier
                        .padding(
                            vertical = 8.dp
